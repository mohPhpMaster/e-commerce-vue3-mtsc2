...
import category_featured_data from "@/data/category-featured-data";
import type {ICategory} from "@/types/category-d-t";
import toolsService from "@/services/toolsService";
const router = useRouter();

let category_items: Ref<ICategory[]> = ref([]);
category_featured_data.then(data=>category_items.value = data);
