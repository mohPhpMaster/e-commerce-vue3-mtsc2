        ...
        <div class="row">
            <div class="col-xxl-12">
              <div class="tp-profile-input-box">
                  ...
                  <div class="tp-profile-input-title">
                    <label for="old_pass">{{ $t('Old Password') }}</label>
                  </div>
              </div>
            </div>
            <div class="col-xxl-6 col-md-6">
              <div class="tp-profile-input-box">
                  ...
                  <div class="tp-profile-input-title">
                    <label for="new_pass">{{ $t('New Password') }}</label>
                  </div>
              </div>
            </div>
            <div class="col-xxl-6 col-md-6">
              <div class="tp-profile-input-box">
                  ...
                  <div class="tp-profile-input-title">
                    <label for="con_new_pass">{{ $t('Confirm New Password') }}</label>
                  </div>
              </div>
            </div>
            <div class="col-xxl-6 col-md-6">
              <div class="profile__btn">
                  <button type="submit" class="tp-btn">{{ $t('Update') }}</button>
              </div>
            </div>
        </div>
      </form>
